...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Podium.Core.Entities.BandStaffPermissions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("CanContactStudents")
                        .HasColumnType("bit");

                    b.Property<bool>("CanManageBand")
                        .HasColumnType("bit");

                    b.Property<bool>("CanManageEvents")
                        .HasColumnType("bit");

                    b.Property<bool>("CanManageOffers")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("BandStaffPermissions");
                });
            ...
            modelBuilder.Entity("Podium.Core.Entities.Offer", b =>
                {
                    ...
                    b.HasIndex("RescindedByUserId");

                    b.HasIndex("RespondedByGuardianUserId");
            ...
            modelBuilder.Entity("Podium.Core.Entities.BandStaff", b =>
                {
                    ...
                    b.HasOne("Podium.Core.Entities.BandStaffPermissions", "Permissions")
                        .WithMany()
            ...
            modelBuilder.Entity("Podium.Core.Entities.Offer", b =>
                {
                    ...
                    b.HasOne("Podium.Core.Entities.ApplicationUser", "RescindedByUser")
                        .WithMany()
                        .HasForeignKey("RescindedByUserId");

                    b.HasOne("Podium.Core.Entities.ApplicationUser", "RespondedByGuardian")
                        .WithMany()
                        .HasForeignKey("RespondedByGuardianUserId");
                    ...
                    b.Navigation("RescindedByUser");

                    b.Navigation("RespondedByGuardian");
